...
class MorphingGradientButton extends StatefulWidget {
  ...
  factory MorphingGradientButton.icon(
      ...
      child: AnimatedScale(
        ...
        child: AnimatedBuilder(
          ...
          builder: (context, child) {
            ...
            final glowStrength = animate
                ? (0.18 + 0.82 * Curves.easeInOut.transform(_pulse.value))
                : 0.0;
            final glowColor =
                colorWithOpacity(shifted.last, 0.26 * glowStrength);
            ...
            return AnimatedPhysicalModel(
              duration:
                  animate ? const Duration(milliseconds: 480) : Duration.zero,
              curve: Curves.easeOutCubic,
